...
import type { BulkScrapeProgess } from "@/app/actions/bulk-scrape";
...
import { startBulkScrapeAction } from "@/app/actions/bulk-scrape";
import { bulkImportSchema, importSchema } from "@/app/schemas/import";
...
export default function ImportPage() {
  ...
  const singleForm = useForm<z.infer<typeof importSchema>>({
  ...
  function onSingleSubmit(data: z.infer<typeof importSchema>) {
  ...
  function onBulkSubmit(data: z.infer<typeof bulkImportSchema>) {
    startTransition(async () => {
          ...
          <TabsContent value="bulk">
            <Card>
              ...
              <CardContent className="space-y-5">
                <form onSubmit={form.handleSubmit(onBulkSubmit)}>
                  <FieldGroup>
                    <Controller
                      name="url"
                      control={form.control}
                    ...
                    <Controller
                      ...
                      render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid}>
                          <FieldLabel htmlFor="form-rhf-demo-search">
                            Search
                          </FieldLabel>
                          <Input
                            {...field}
